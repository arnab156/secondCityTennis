          ...
          <TabPane tabId="1">
            <Row>
              <Col sm="12">
                ...
                This program provides beginning and intermediate players (and those who haven’t played in a while) a fun environment to develop skills quickly and encourage match play. 
                <br/>
                2-hour clinics run for 5-weeks, typically on weekends at the Diversey Clay Courts with an experienced instructor. This program runs from early June with multiple 5-week session throughout the summer.
                </p>
              </Col>
            </Row>
            <br/>
